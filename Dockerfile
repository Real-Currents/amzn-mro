...
RUN /var/task/bin/Rscript -e 'install.packages(c("rlang", "devtools", "geojsonsf", "geoviz", "jsonlite", "magick", "magrittr", "openxlsx", "Rcpp", "RcppRedis", "raster", "remoter", "remotes", "rgdal", "rgeos", "sf", "sp", "stringi", "stringr", "slippymath", "terra"));' && \
