...
RUN export PATH=/root/bin:$PATH && cd /var/task && \
    ...
    Rscript -e 'install.packages("jsonlite"); install.packages("openxlsx"); install.packages("rmarkdown"); install.packages("stringr"); install.packages("tidyverse");install.packages("DT"); install.packages("devtools"); install.packages("blogdown"); blogdown::install_hugo("0.64.0");'
